...
@click.option('-mtcpi',
	'--map_total_cases_per_10000_inhabitants',
	is_flag=True,
	help="Create a Leaflet layer with the data of the cumulative cases per 10000 inhabitants of the given country(ies)")
@click.option('-mtdpi',
	'--map_total_deaths_per_10000_inhabitants',
	is_flag=True,
	help="Create a Leaflet layer with the data of the cumulative deaths per 10000 inhabitants of the given country(ies)")
@click.option('-ptd',
	'--plot_total_deaths',
	is_flag=True,
...
def map(output_folder, map_total_deaths, map_total_cases, map_deaths_of_the_day, map_cases_of_the_day,
	map_cases_of_the_day_per_10000_inhabitants, map_deaths_of_the_day_per_10000_inhabitants, map_total_cases_per_10000_inhabitants, map_total_deaths_per_10000_inhabitants,
	...
	if map_deaths_of_the_day or map_cases_of_the_day or map_total_deaths or map_total_cases or map_cases_of_the_day_per_10000_inhabitants or map_deaths_of_the_day_per_10000_inhabitants or map_total_cases_per_10000_inhabitants or map_total_deaths_per_10000_inhabitants:
		if map_total_cases:
			if plot_cases_of_the_day:
				...
				map_chloro(index_layer=4, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)				
			...
			if plot_cases_of_the_day:
				...
				map_chloro(index_layer=5, index_plot=6, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_deaths_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=5, index_plot=7, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_cases_per_10000_inhabitants:
				map_chloro(index_layer=5, index_plot=8, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=5, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)
			elif not plot_cases_of_the_day and not plot_deaths_of_the_day and not plot_total_deaths and not plot_total_cases and not plot_cases_of_the_day_per_10000_inhabitants and not plot_deaths_of_the_day_per_10000_inhabitants and not plot_total_cases_per_10000_inhabitants and not plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=5, index_plot=5, min_plot=float(plot_min), output_folder=output_folder)
			...
			if plot_cases_of_the_day:
				...
				map_chloro(index_layer=3, index_plot=6, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_deaths_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=3, index_plot=7, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_cases_per_10000_inhabitants:
				map_chloro(index_layer=3, index_plot=8, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=3, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)
			elif not plot_cases_of_the_day and not plot_deaths_of_the_day and not plot_total_deaths and not plot_total_cases and not plot_cases_of_the_day_per_10000_inhabitants and not plot_deaths_of_the_day_per_10000_inhabitants and not plot_total_cases_per_10000_inhabitants and not plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=3, index_plot=3, min_plot=float(plot_min), output_folder=output_folder)
			...
			if plot_cases_of_the_day:
				...
				map_chloro(index_layer=2, index_plot=6, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_deaths_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=2, index_plot=7, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_cases_per_10000_inhabitants:
				map_chloro(index_layer=2, index_plot=8, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=2, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)
			elif not plot_cases_of_the_day and not plot_deaths_of_the_day and not plot_total_deaths and not plot_total_cases and not plot_cases_of_the_day_per_10000_inhabitants and not plot_deaths_of_the_day_per_10000_inhabitants and not plot_total_cases_per_10000_inhabitants and not plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=2, index_plot=2, min_plot=plot_min, output_folder=output_folder)
		...
		elif map_total_cases_per_10000_inhabitants:
			if plot_cases_of_the_day:
				map_chloro(index_layer=8, index_plot=2, min_plot=plot_min, output_folder=output_folder)
			elif plot_deaths_of_the_day:
				map_chloro(index_layer=8, index_plot=3, min_plot=plot_min, output_folder=output_folder)
			elif plot_total_cases:
				map_chloro(index_layer=8, index_plot=4, min_plot=plot_min, output_folder=output_folder)
			elif plot_total_deaths:
				map_chloro(index_layer=8, index_plot=5, min_plot=plot_min, output_folder=output_folder)
			elif plot_cases_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=8, index_plot=6, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_deaths_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=8, index_plot=7, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_cases_per_10000_inhabitants:
				map_chloro(index_layer=8, index_plot=8, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=8, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)
			elif not plot_cases_of_the_day and not plot_deaths_of_the_day and not plot_total_deaths and not plot_total_cases and not plot_cases_of_the_day_per_10000_inhabitants and not plot_deaths_of_the_day_per_10000_inhabitants and not plot_total_cases_per_10000_inhabitants and not plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=8, index_plot=2, min_plot=plot_min, output_folder=output_folder)

		elif map_total_deaths_per_10000_inhabitants:
			if plot_cases_of_the_day:
				map_chloro(index_layer=9, index_plot=2, min_plot=plot_min, output_folder=output_folder)
			elif plot_deaths_of_the_day:
				map_chloro(index_layer=9, index_plot=3, min_plot=plot_min, output_folder=output_folder)
			elif plot_total_cases:
				map_chloro(index_layer=9, index_plot=4, min_plot=plot_min, output_folder=output_folder)
			elif plot_total_deaths:
				map_chloro(index_layer=9, index_plot=5, min_plot=plot_min, output_folder=output_folder)
			elif plot_cases_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=9, index_plot=6, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_deaths_of_the_day_per_10000_inhabitants:
				map_chloro(index_layer=9, index_plot=7, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_cases_per_10000_inhabitants:
				map_chloro(index_layer=9, index_plot=8, min_plot=float(plot_min), output_folder=output_folder)
			elif plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=9, index_plot=9, min_plot=float(plot_min), output_folder=output_folder)
			elif not plot_cases_of_the_day and not plot_deaths_of_the_day and not plot_total_deaths and not plot_total_cases and not plot_cases_of_the_day_per_10000_inhabitants and not plot_deaths_of_the_day_per_10000_inhabitants and not plot_total_cases_per_10000_inhabitants and not plot_total_deaths_per_10000_inhabitants:
				map_chloro(index_layer=9, index_plot=2, min_plot=plot_min, output_folder=output_folder)
